...
// DrawEllipse.cpp: определяет поведение классов для приложения.
//
...
// Создание CDrawEllipseApp

CDrawEllipseApp::CDrawEllipseApp()
{
...
// Единственный объект CDrawEllipseApp

CDrawEllipseApp theApp;


// Инициализация CDrawEllipseApp
